...
export class MapRoadtripComponent implements AfterViewInit {
  ...
  getMarkerSvg(stepNumber: string) {
    ...
    svgElement.innerHTML = svgInner.replace(/(#STEP_NUMBER#)/g, stepNumber);
